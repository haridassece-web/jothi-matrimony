        ...
        <div style={{
          ...
          <div>
            ...
            <ul style={{ listStyle: 'none', display: 'flex', flexDirection: 'column', gap: '0.3rem', fontSize: '0.78rem', color: '#E8DCD3', padding: 0, margin: 0 }}>
              <li><button onClick={() => setActivePage('home')} style={linkBtnStyle}>Home / முகப்பு</button></li>
              <li><button onClick={() => setActivePage('register')} style={linkBtnStyle}>₹1,000 Registration</button></li>
              <li><button onClick={() => setActivePage('payment')} style={linkBtnStyle}>Payment Options</button></li>
              <li><button onClick={() => setActivePage('alliances')} style={linkBtnStyle}>Browse Tamil Alliances</button></li>
              <li><button onClick={() => setActivePage('about')} style={linkBtnStyle}>About & Office Hours</button></li>
            </ul>
          </div>
