...
export default function ShortlistPage({ setActivePage, onSelectProfile }) {
      ...
      <div className="container" style={{ maxWidth: '840px' }}>
        ...
        {savedProfiles.length === 0 ? (
          <div className="card" style={{ padding: '3rem', textAlign: 'center' }}>
            ...
            <button onClick={() => setActivePage('alliances')} className="btn btn-primary btn-sm" style={{ marginTop: '1rem' }}>
              Browse Alliances →
            </button>
          </div>
        ) : (
